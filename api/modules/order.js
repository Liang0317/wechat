...
export default {
	...
	//获取服务方式
	getServiceType(param) {
		return req.get("massage/app/IndexOrder/getServiceType", param)
	},
	//获取升级订单信息
	upOrderInfo(param) {
	...
	//升级服务下单重新支付
	rePayUpOrder(param) {
		return req.post("massage/app/IndexOrder/rePayUpOrder", param)
	},
	//校验加钟订单是否可下单
	checkAddOrder(param) {
	...
	//订单详情
	adapayOrderInfo(param) {
		return req.get("massage/app/IndexOrder/adapayOrderInfo", param)
	},
	//订单详情
	orderInfo(param) {
	...
	//完成服务
	endOrder(param) {
		return req.post("massage/app/IndexOrder/endOrder", param)
	},
	//确认完成订单
	userSignOrder(param) {
